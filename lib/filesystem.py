...
def export_hosts_headers(hosts_file, custom_hosts):
    """
    Keyword arguments:
...
def export_hosts_file(hosts_file, custom_hosts, blocked_hosts, blacklisted_hosts):
    """Export the database to a text file.

    Keyword arguments:
    filename -- The file where the database will be exported
    """
    export_hosts_headers(hosts_file, custom_hosts)
